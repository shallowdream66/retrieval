...
class MSVD_DataLoader(Dataset):
    ...
    def _get_text(self, video_id, caption):
        ...
        return pairs_text, pairs_mask, pairs_segment, choice_video_ids, caption
    ...
    def __getitem__(self, idx):
        ...
        pairs_text, pairs_mask, pairs_segment, choice_video_ids, captions = self._get_text(video_id, caption)
        video, video_mask = self._get_rawvideo(choice_video_ids)
        return pairs_text, pairs_mask, pairs_segment, video, video_mask, captions
